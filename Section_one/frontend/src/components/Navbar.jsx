            ...
            <ul className="navbar-nav d-flex flex-row mx-3" >
              <li class="nav-item dropdown ">
                ...
                <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                  ...
                  <li><a class="dropdown-item text-dark" href="/signup">Register</a></li>
                </ul>
              </li>
            </ul>
          </div>
      ...
      <nav className="navbar navbar-expand-lg  bg-light border border-1 fixed-top p-2">
        <div className="container-fluid">
          <a className="navbar-brand mx-2 p-0" href="/home">
            <img height={100} width={100} src="https://head-held-high.org/wp-content/uploads/2021/03/craftizen-logo-300x300.jpg" alt="" />
          </a>
          <button
            ...
            <ul className="navbar-nav me-auto my-1 mb-lg-0 mx-3 navbar-nav-scroll">
              <li className="nav-item dropdown">
                ...
                <ul className="dropdown-menu">
                  <li>
                    <a className="dropdown-item" href="/browse">
                     All Items
                    </a>
                  </li>
                </ul>
              ...
              <li className="nav-item nav-item dropdown mx-1">
                <NavLink className="nav-link fw-bold text-dark" to="/productlist">
                  ACCESSORIES
                </NavLink>
              </li>
